...
I forked this package for a specific project that required the following needs:

- Automatically zoom to fit the bounds of the viewport on load to not show empty space for users
- Handling of URLs via pre-signed manifest + image URIs hosted in private blob storage
- TypeScript support for easier development

### ToDos

- Update test suite to use new technology
- Add working examples - Need to detach my business logic from pure examples
